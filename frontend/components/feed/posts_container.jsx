...
import { editPost, destroyPost, likePost, unlikePost, followPost, unfollowPost, editFilePost } from '../../actions/post_actions';
...
const mapDispatchToProps = (dispatch) => ({
  ...
  editFilePost: (post) => dispatch(editFilePost(post)),
